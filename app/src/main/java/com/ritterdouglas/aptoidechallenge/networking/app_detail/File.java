...
public class File {
    ...
    public void setPathAlt(String path_alt) {
        mPathAlt = path_alt;
    }
    ...
    public void setUsedFeatures(List<String> used_features) {
        mUsedFeatures = used_features;
    }
    ...
    public void setUsedPermissions(List<String> used_permissions) {
        mUsedPermissions = used_permissions;
    }
